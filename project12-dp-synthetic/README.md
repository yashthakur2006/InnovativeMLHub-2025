...
DP-conscious synthetic tabular data generator for civic analytics. Implements PATE-/DP-SGD-inspired variants with equity-aware utility checks.

Innovation: downstream policy-simulation hooks (e.g., bus route planning) to evaluate usefulness.
...
## Key techniques
- PATE-/DP-SGD-inspired GAN-lite, privacy/utility auditing, fairness checks

## Datasets (public)
- UCI Census-like: https://archive.ics.uci.edu/
- Local open-data portal (tabular)
