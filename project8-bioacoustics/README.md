...
Urban biodiversity monitoring from sound. Train a compact audio encoder on bird calls with noise-robust techniques; ship a CPU-first multilabel classifier.

Innovation: few-shot adapters for local species and sound-postcards for parks.
...
## Key techniques
- audio SSL-lite, multilabel classification, noise-robust training

## Datasets (public)
- BirdCLEF (latest available on Kaggle): https://www.kaggle.com/c/birdclef-2024
